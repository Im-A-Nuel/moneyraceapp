...
export default function CreateRoom() {
  ...
  const [isTestMode, setIsTestMode] = useState(false); // Test mode: 1 minute periods instead of 1 week
  ...
  const handleCreateRoom = async () => {
    ...
    try {
      // Convert UI data to backend format (use test mode function if enabled)
      ...
      // Add privacy settings (password will be auto-generated by backend)
      const roomDataWithPrivacy = {
        ...roomData,
        isPrivate,
      };
      ...
      if (response.success) {
        // If private room, show password modal with Room ID
                ...
                {isPrivate && (
                  <div className="bg-purple-50 border border-purple-200 rounded p-3">
                    <p className="text-xs text-purple-800">
                      ...
                      You can share it with people you want to invite.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="border-t pt-4 space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="isTestMode" className="cursor-pointer">
                    🧪 Enable Test Mode (1 minute periods)
                  </Label>
                </div>
                ...
                {isTestMode && (
                  <div className="bg-orange-50 border border-orange-200 rounded p-3">
                    <p className="text-xs text-orange-800">
                      ⚡ <strong>Test Mode:</strong> Each "week" will be only 1 minute long.
                      This allows you to test deposits for week 2, 3, etc. quickly.
                      <br />
                      <span className="text-orange-600">• Wait 1 minute after joining to deposit for week 2</span>
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {isTestMode && (
                  <div className="flex justify-between py-2 border-b">
                    ...
                    <span className="font-semibold text-orange-600">🧪 Test Mode (1 min periods)</span>
                  </div>
                )}
              </div>
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <Card className="max-w-lg w-full">
            <CardHeader>
              <CardTitle>🔒 Private Room Created!</CardTitle>
              <CardDescription>Save this information - it will only be shown once</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {/* Room ID */}
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded p-3">
                <p className="text-xs text-yellow-800">
                  ...
                  Share the Room ID and Password with people you want to invite.
                </p>
              </div>
